...
Once the `conda-forge` channel has been enabled, `antlr-python-runtime, antlr4-python3-runtime` can be installed with `conda`:
...
```
mamba install antlr-python-runtime antlr4-python3-runtime
```
